...
"undefined" == typeof jQuery.migrateMute && (jQuery.migrateMute = !0),
    function(t) {
        ...
        s.swap && s.each(["height", "width", "reliableMarginRight"], function(e, t) {
            ...
            }(r = v(e)) || s.cssNumber[r] || u('Number-typed values are deprecated for jQuery.fn.css( "' + e + '", value )')), j.apply(this, arguments)
        };
        var x = s.data;
        ...
        s.event.props = [], s.event.fixHooks = {}, t(s.event.props, "concat", s.event.props.concat, "jQuery.event.props.concat() is deprecated and removed"), s.event.fix = function(e) {
            ...
            s.fn[t] = function() {
                ...
                return "load" === t && "string" == typeof e[0] ? N.apply(this, e) : (u("jQuery.fn." + t + "() is deprecated"), e.splice(0, 0, t), arguments.length ? this.on.apply(this, e) : (this.triggerHandler.apply(this, e), this))
            }
        ...
        if (s.fn.offset = function() {
                var e = this[0];
                return !e || e.nodeType && e.getBoundingClientRect ? D.apply(this, arguments) : (u("jQuery.fn.offset() requires a valid DOM element"), arguments.length ? this : void 0)
            }, s.ajax) {
            var _ = s.param;
            s.param = function(e, t) {
                var r = s.ajaxSettings && s.ajaxSettings.traditional;
                return void 0 === t && r && (u("jQuery.param() no longer uses jQuery.ajaxSettings.traditional"), t = r), _.call(this, e, t)
            }
        }
        var E = s.fn.andSelf || s.fn.addBack;
        if (s.fn.andSelf = function() {
                return u("jQuery.fn.andSelf() is deprecated and removed, use jQuery.fn.addBack()"), E.apply(this, arguments)
            }, s.Deferred) {
            var F = s.Deferred,
                O = [
